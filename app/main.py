...
# ==================== FRONTEND HOME ENTRY WITH REGISTER FORMS ====================
...
def read_root():
    ...
    <head>
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
            ...
            /* Interactive Form Popups (Modals) */
            ...
            .modal-content { background: white; padding: 35px; border-radius: 20px; width: 100%; max-width: 450px; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.1); position: relative; animation: slideUp 0.3s ease; }
            ...
            .form-group input, .form-group select { width: 100%; padding: 12px 16px; border: 1px solid #cbd5e1; border-radius: 10px; outline: none; font-size: 0.95rem; }
    ...
    <body>
        <!-- Top Navigation with Custom Buttons -->
        <nav>
        ...
        <script>
            ...
            // Handle API Form submissions dynamically to live PostgreSQL DB
